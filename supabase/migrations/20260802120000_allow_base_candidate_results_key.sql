-- Applied to prod 2026-08-02 via MCP.
-- Whitelist base_candidate_results for the merge RPC (candidate-pool base
-- generation merges each generated image into an N-slot array), and make the
-- empty-array fallback size-agnostic.
